<template>
  <div class=" main_container_banner favorite_category_product">
    ...
    <div class="row row_product_child row_product_child_container_width ">
      <div class="card-carousel-wrapper"
        ...
        <ul v-for="item in products">
          <a v-bind:href="'http://localhost:8081/card/'+item.productId" class="favorute_card_hover">
            <li>
              <div class="carousel_unit">
...
<style>
  ...
  .row_product_child_container_width {
    width: 660px;
  }
</style>
